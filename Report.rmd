...
```{r}
t.test(highvar_group[, dif], control_group[, dif], alternative = "two.sided")$p.value
t.test(leftskew_group[, dif], control_group[, dif], alternative = "two.sided")$p.value
t.test(rightskew_group[, dif], control_group[, dif], alternative = "two.sided")$p.value
```
