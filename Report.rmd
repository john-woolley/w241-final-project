...
Once aligned on this experimental design, we had initially conducted a power calculation to determine the N that we would need to collect to find a statistically significant difference between treatment groups. We had initially aligned that we would be looking
...
```{r dist, include=FALSE, fig.width=10,fig.height=10,fig.cap='Population distribution for (a) Control, (b) High Variance, (c) Left-Skew, (d) Right-Skew '}
knitr::opts_chunk$set(echo = FALSE)
#2x2 histogram
line = 1
cex = 2
...
```{r ri, include=FALSE, fig.width=10,fig.height=10,fig.cap='Randomization Inference '}
knitr::opts_chunk$set(echo = FALSE)
#2x2 histogram
line = 1
cex = 2
